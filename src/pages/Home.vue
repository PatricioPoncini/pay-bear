...
<template>
  <div class="grid grid-cols-1">
    <div class="flex flex-col items-center gap-4 pt-6 sm:pt-10">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6 md:gap-8 place-items-center mt-8 sm:mt-12 md:mt-16 mb-10">
        <HomeCard
        ...
        <HomeCard
            ...
            description="Sell your cryptocurrencies securely"
            route-to="sell"
        ...
        <HomeCard
            ...
            description="Analyze the performance of your investments"
            route-to="analysis"
